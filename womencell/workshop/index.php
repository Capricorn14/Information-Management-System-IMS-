                ...
                <form action="insertcode.php" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Enter Title of Workshop or Seminar" required>
                        </div>
...
?>
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">					
				<button type="submit" onclick="exportTableToCSVuser('USerData_Womencell_workshopseminar.csv')" class="btn btn-success">Export to excel</button>
			</form> &nbsp; &nbsp; 
