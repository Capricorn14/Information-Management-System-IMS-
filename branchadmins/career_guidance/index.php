                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        <tbody> <!-- change -->
                            <tr>
                                ...
                                <td>
                                <a href="../../placementcell/career_guide/uploadsfdporganised/<?php echo $developer['pdffile']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
