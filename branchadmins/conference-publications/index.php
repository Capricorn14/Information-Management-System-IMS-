                ...
                while ($developer = mysqli_fetch_assoc($query_run)) {
                    ...
                    <tbody> <!-- change -->
                        ...
                        <td> <?php echo $developer['id']; ?> </td>
							...
							<a href="../../professors/conference-publications/Conference_Paper/<?php echo $developer['pdffile2']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="../../professors/conference-publications/Conference_Certificate/<?php echo $developer['pdffile3']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
    ...
    $queryresult = mysqli_num_rows($result); ?>
                ...
                while($row = mysqli_fetch_assoc($result)){   
                    ...
                    <td> <?php echo $row['id']; ?> </td>
                        ...
                        <a href="../../professors/conference-publications/Conference_Paper/<?php echo $row['pdffile2']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="../../professors/conference-publications/Conference_Certificate/<?php echo $row['pdffile3']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a class="edit btn-success editbtn" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                        <a class="delete btn-danger deletebtn" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                    </td>
                    <td>
