                    ...
                    <tbody> <!-- change -->
                        ...
                        <td> <?php echo $developer['id']; ?> </td>
                            ...
                            <td>
                                ...
                                <a href="../../professors/fdp-sttp-attended/uploadsfdpattended2/<?php echo $developer['pdffile2']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                ...
                ?>  
                           <td> <?php echo $row['id']; ?> </td>
                            ...
                            <td>
                                ...
                                <a href="../../professors/fdp-sttp-attended/uploadsfdpattended2/<?php echo $row['pdffile2']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                                <a class="edit btn-success editbtn" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                <a class="delete btn-danger deletebtn" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                <td>
