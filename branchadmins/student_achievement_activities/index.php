...
?>
            ...
            <div id="tabledataid" class="card">
                ...
                ?>
                            ...
                            <a href="../../student/achievement_activities/certificates/<?php echo $developer['pdffile1']; ?>" target="_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
