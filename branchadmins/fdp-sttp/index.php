...
?>
            ...
            <div id="tabledataid" class="card">
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../activity_coordinator/fdp-sttp/uploadsfdporganised/<?php echo $developer['pdffile']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip">
        ...
        $queryresult = mysqli_num_rows($result); ?>
                ...
                while($row = mysqli_fetch_assoc($result)){   
                    ...
                    <tr>                
                        ...
                        <td>
                        <a href="../../activity_coordinator/fdp-sttp/uploadsfdporganised/<?php echo $row['pdffile']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip">
                            <i class="fa fa-download"></i>
                        </a>
                        <a class="edit btn-success editbtn" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                        <a class="delete btn-danger deletebtn" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
