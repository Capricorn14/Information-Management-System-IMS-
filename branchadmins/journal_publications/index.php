                ...
                while ($developer = mysqli_fetch_assoc($query_run)) {
                    ...
                    <tbody> <!-- change -->
                        ...
                        <td> <?php echo $developer['id']; ?> </td>
                            ...
                            <td>
                            <a href="../../professors/journal_publications/JournalPaper/<?php echo $developer['Journal_Paper']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                ...
                while($row = mysqli_fetch_assoc($result)){   
                    ...
                    <td> <?php echo $row['id']; ?> </td>
                        ...
                        <td>
                            ...
                            <a href="../../professors/journal_publications/JournalPaper/<?php echo $row['Journal_Paper']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
