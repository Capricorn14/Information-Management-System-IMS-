 ...
 <!-- buttons and search buttoncard -->
            ...
            <div id="tabledataid" class="card">
                ...
                ?>
                            ...
                            <!-- <a href="certificates1/<?php echo $developer['pdffile1']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a> -->
                            <a href="certificates2/<?php echo $developer['pdffile2']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="certificates3/<?php echo $developer['pdffile3']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
        ...
        $queryresult = mysqli_num_rows($result); ?>
                ...
                ?>  
                        ...
                        <td>
                            ...
                            <!-- <a class="edit btn-success editbtn" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a> -->
                            <a href="certificates1/<?php echo $row['pdffile1']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="certificates2/<?php echo $row['pdffile2']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="certificates3/<?php echo $row['pdffile3']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
