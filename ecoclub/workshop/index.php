...
?>
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">					
				<button type="submit" onclick="exportTableToCSVuser('USerData_Workshops_Seminar_ecoclub.csv')" class="btn btn-success">Export to excel</button>
			</form> &nbsp; &nbsp; 
    ...
    if (isset($_POST["submit"])) {
        ...
        $queryresult = mysqli_num_rows($result); ?>
                    ...
                    <div class="card">
                        <div class="card-body btn-group">
                        <div> Results- </div> &nbsp; &nbsp;
                        <button class="btn btn-success" onclick="exportTableToCSV('Search_data_ecoclub_workshopseminar.csv')"> Export Data </button>
                        </div>
                    </div>
