...
?>
            ...
            <div id="tabledataid" class="card">
                ...
                ?>
                                ...
                                <td>
                                <a href="uploadsindex1/<?php echo $developer['pdffile1']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip">
    ...
    if (isset($_POST["submit"])) {
        ...
        $queryresult = mysqli_num_rows($result); ?>
                ...
                ?>               
                        ...
                        <td>
                            <a href="uploadsindex1/<?php echo $row['pdffile1']; ?>" target = "_blank" class="download" title="Download" data-toggle="tooltip">
